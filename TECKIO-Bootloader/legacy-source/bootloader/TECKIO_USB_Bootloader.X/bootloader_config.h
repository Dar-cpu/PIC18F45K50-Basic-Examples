...
#define TKBL_BOOT_START          0x0000u
#define TKBL_BOOT_END            0x2000u
#define TKBL_APP_START           0x2000u
#define TKBL_METADATA_START      0x7FC0u
#define TKBL_APP_END             TKBL_METADATA_START
#define TKBL_FLASH_END           0x8000u
